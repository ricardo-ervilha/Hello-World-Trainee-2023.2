        ...
        <div class="card-container grid-template-columns">
            ...
            <div class="central">
                ...
                <div class="main-content">
                    <p>JavaScript é uma linguagem de programação amplamente utilizada no desenvolvimento web, permitindo a criação de páginas interativas e dinâmicas. Desenvolvida inicialmente para ser executada nos navegadores, a linguagem conquistou uma posição central no universo da programação, sendo hoje também empregada em ambientes de servidor e até mesmo em aplicativos de desktop.</p>
                    <img src="../../../public/assets//javaScript.png" class="icone">
